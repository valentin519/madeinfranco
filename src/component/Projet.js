...
const Projet =() => (
    ...
    <div className='projet' id='projet'>
        <p>- La 2ème édition du Concours des Jeunes Designers de Mode Francophones sera organisé à l'automne 2020 ou au printemps 2021 selon les contraintes liées à l'actualité. Cette 2ème édition permettrait de faire émerger un Concours-caravane dans les pays participants, puis un défilé-caravane qu'accueilleraient plusieurs villes françaises.</p>
        <p>- Publication de "2020... dixit de Gaulle", un ouvrage écrit à 4 mains par Bernard Namura et Lucie Gëloen.
                ...
                Allons ensemble à la rencontre de ces personnages qui reviennent dans nos vies 30 plus tard. Pour certains d’entre nous, il s’agira de découvrir l’étonnante clairvoyance et humanité d’un visionnaire, pour d’autres de trouver réponses à bien des questions dans un monde à réinventer…
